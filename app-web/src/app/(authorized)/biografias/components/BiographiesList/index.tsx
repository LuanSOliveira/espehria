...
import { BiographiesListItem } from '../BiographiesListItem';

export interface BiographiesListProps {
  biographies: IBiographyListItem[];
  total: number;
  page: number;
  isLoading: boolean;
  onPageChange: (newPage: number) => void;
  onView: (biography: IBiographyListItem) => void;
  onEdit: (biography: IBiographyListItem) => void;
  onDelete: (biography: IBiographyListItem) => void;
}

export const BiographiesList = ({
  biographies,
  total,
  page,
  isLoading,
  ...
  return (
    <TableContainer className="mt-6">
      <Table>
        ...
        <TableBody>
          {!isLoading && biographies.length === 0 && (
            <TableRow>
