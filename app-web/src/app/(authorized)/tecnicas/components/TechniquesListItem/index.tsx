...
export interface TechniquesListItemProps {
  technique: ITechniqueListItem;
...
export const TechniquesListItem = ({
  technique,
  onView,
  onEdit,
  onDelete,
}: TechniquesListItemProps) => {
  ...
  return (
    ...
    >
      ...
      <TableCell sx={{ borderColor: APP_COLORS.gold }}>
        <DefaultText>{technique.name}</DefaultText>
      </TableCell>
      <TableCell sx={{ borderColor: APP_COLORS.gold }}>
        <DefaultText>{technique.level}</DefaultText>
      </TableCell>
      <TableCell sx={{ borderColor: APP_COLORS.gold }}>
