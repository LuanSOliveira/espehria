...
export interface CharactersFilterSectionProps {
  nameValue: string;
...
export const CharactersFilterSection = ({
  nameValue,
  onNameChange,
  tagsValue,
  onTagsChange,
