...
export interface AmmunitionFilterSectionProps {
  nameValue: string;
...
export const AmmunitionFilterSection = ({
  nameValue,
  onNameChange,
  tagsValue,
  onTagsChange,
