...
export interface AmmunitionListItemProps {
  ammunition: IAmmunitionListItem;
  onView: (ammunition: IAmmunitionListItem) => void;
  onEdit: (ammunition: IAmmunitionListItem) => void;
  onDelete: (ammunition: IAmmunitionListItem) => void;
}
