...
export interface TalentsFilterSectionProps {
  nameValue: string;
...
export const TalentsFilterSection = ({
  nameValue,
  onNameChange,
  levelValue,
  onLevelChange,
