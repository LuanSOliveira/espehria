...
export interface ConsumablesFilterSectionProps {
  nameValue: string;
...
export const ConsumablesFilterSection = ({
  nameValue,
  onNameChange,
  tagsValue,
  onTagsChange,
  ...
  onSubmit,
  onClear,
}: ConsumablesFilterSectionProps) => {
  return (
    <form
      onSubmit={onSubmit}
      className="mt-6 flex max-w-200 flex-wrap items-end gap-3"
    >
      <div className="min-w-50 flex-1">
        <DefaultTextInput
          id="consumables-name-filter"
          label="Nome"
