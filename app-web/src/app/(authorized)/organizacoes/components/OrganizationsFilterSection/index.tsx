...
export interface OrganizationsFilterSectionProps {
  nameValue: string;
...
export const OrganizationsFilterSection = ({
  nameValue,
  onNameChange,
  tagsValue,
  onTagsChange,
  ...
  onSubmit,
  onClear,
}: OrganizationsFilterSectionProps) => {
  return (
    <form
      onSubmit={onSubmit}
