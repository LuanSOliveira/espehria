...
import { IConditionSection } from '@/shared/interfaces';
import { APP_COLORS, APP_CONTAINER_STYLES } from '@/shared/constants';

export interface ConditionSectionCardProps {
  section: IConditionSection;
}

export const ConditionSectionCard = ({
  section,
}: ConditionSectionCardProps) => {
  return (
