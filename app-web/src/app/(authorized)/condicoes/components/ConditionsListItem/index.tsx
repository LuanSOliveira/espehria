...
export interface ConditionsListItemProps {
  condition: IConditionListItem;
...
export const ConditionsListItem = ({
  condition,
  onView,
  onEdit,
  onDelete,
}: ConditionsListItemProps) => {
  ...
  return (
    ...
    >
      <TableCell sx={{ borderColor: APP_COLORS.gold }}>
        <DefaultText>{condition.name}</DefaultText>
      </TableCell>
