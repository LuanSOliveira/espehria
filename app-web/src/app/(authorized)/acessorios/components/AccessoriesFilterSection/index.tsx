...
export interface AccessoriesFilterSectionProps {
  nameValue: string;
...
export const AccessoriesFilterSection = ({
  nameValue,
  onNameChange,
  tagsValue,
  onTagsChange,
