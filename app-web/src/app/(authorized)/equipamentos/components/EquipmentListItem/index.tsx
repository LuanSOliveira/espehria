...
export interface EquipmentListItemProps {
  ...
  onView: (equipment: IEquipmentListItem) => void;
  onEdit: (equipment: IEquipmentListItem) => void;
  onDelete: (equipment: IEquipmentListItem) => void;
}
...
export const EquipmentListItem = ({
  ...
  return (
    ...
    >
      ...
      <TableCell sx={{ borderColor: APP_COLORS.gold }}>
        <DefaultText>{equipment.name}</DefaultText>
      </TableCell>
      <TableCell sx={{ borderColor: APP_COLORS.gold }}>
