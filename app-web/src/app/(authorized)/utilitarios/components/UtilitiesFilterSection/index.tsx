...
export interface UtilitiesFilterSectionProps {
  nameValue: string;
...
export const UtilitiesFilterSection = ({
  nameValue,
  onNameChange,
  tagsValue,
  onTagsChange,
