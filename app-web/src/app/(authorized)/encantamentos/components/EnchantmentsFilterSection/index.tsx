...
export interface EnchantmentsFilterSectionProps {
  nameValue: string;
...
export const EnchantmentsFilterSection = ({
  nameValue,
  onNameChange,
  typeValue,
  onTypeChange,
  onSubmit,
  onClear,
}: EnchantmentsFilterSectionProps) => {
  return (
    <form
      onSubmit={onSubmit}
