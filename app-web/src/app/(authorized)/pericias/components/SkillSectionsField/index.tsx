...
import { SkillFormData } from '@/shared/formSchemas';
import { APP_COLORS } from '@/shared/constants';

export interface SkillSectionsFieldProps {
  control: Control<SkillFormData>;
}

export const SkillSectionsField = ({ control }: SkillSectionsFieldProps) => {
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          {fields.map((field, index) => (
            <div key={field.id} className="flex flex-col gap-3">
              ...
              <FormRichTextInput
                id={`skill-section-description-${index}`}
