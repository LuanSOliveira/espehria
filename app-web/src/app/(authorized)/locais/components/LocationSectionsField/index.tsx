...
import { LocationFormData } from '@/shared/formSchemas';
import { APP_COLORS } from '@/shared/constants';

export interface LocationSectionsFieldProps {
  control: Control<LocationFormData>;
}

export const LocationSectionsField = ({
  control,
}: LocationSectionsFieldProps) => {
            ...
            <div key={field.id} className="flex flex-col gap-3">
              <div className="flex items-end gap-2">
                <div className="flex-1">
                  <FormTextInput
                    id={`location-section-label-${index}`}
              ...
              <FormRichTextInput
                id={`location-section-description-${index}`}
