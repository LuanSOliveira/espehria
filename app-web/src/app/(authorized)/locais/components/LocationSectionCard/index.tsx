...
import { ILocationSection } from '@/shared/interfaces';
import { APP_COLORS, APP_CONTAINER_STYLES } from '@/shared/constants';

export interface LocationSectionCardProps {
  section: ILocationSection;
}

export const LocationSectionCard = ({ section }: LocationSectionCardProps) => {
  return (
