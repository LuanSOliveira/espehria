...
import { PlannedSessionFormData } from '@/shared/formSchemas';
import { APP_COLORS } from '@/shared/constants';

export interface PlannedSessionSectionsFieldProps {
  control: Control<PlannedSessionFormData>;
}

export const PlannedSessionSectionsField = ({
  control,
}: PlannedSessionSectionsFieldProps) => {
            ...
            <div key={field.id} className="flex flex-col gap-3">
              <div className="flex items-end gap-2">
                <div className="flex-1">
                  <FormTextInput
                    id={`planned-session-section-label-${index}`}
              ...
              <FormRichTextInput
                id={`planned-session-section-description-${index}`}
