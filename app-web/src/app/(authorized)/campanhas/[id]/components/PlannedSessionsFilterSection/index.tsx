...
export interface PlannedSessionsFilterSectionProps {
  nameValue: string;
...
export const PlannedSessionsFilterSection = ({
  nameValue,
  onNameChange,
  tagsValue,
  onTagsChange,
  ...
  onSubmit,
  onClear,
}: PlannedSessionsFilterSectionProps) => {
  return (
    <form
      onSubmit={onSubmit}
    ...
    >
      <div className="min-w-50 flex-1">
        <DefaultTextInput
          id="planned-sessions-name-filter"
          label="Nome"
      ...
      <div className="min-w-60 flex-1">
        <DefaultMultiAutocompleteInput<ITag>
          id="planned-sessions-tags-filter"
          label="Tags"
          options={tagOptions}
