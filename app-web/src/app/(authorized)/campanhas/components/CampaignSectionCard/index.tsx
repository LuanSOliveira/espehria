...
import { ICampaignSection } from '@/shared/interfaces';
import { APP_COLORS, APP_CONTAINER_STYLES } from '@/shared/constants';

export interface CampaignSectionCardProps {
  section: ICampaignSection;
}

export const CampaignSectionCard = ({ section }: CampaignSectionCardProps) => {
  return (
