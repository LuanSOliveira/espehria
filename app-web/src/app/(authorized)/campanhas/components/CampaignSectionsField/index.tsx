...
import { CampaignFormData } from '@/shared/formSchemas';
import { APP_COLORS } from '@/shared/constants';

export interface CampaignSectionsFieldProps {
  control: Control<CampaignFormData>;
}

export const CampaignSectionsField = ({
  control,
}: CampaignSectionsFieldProps) => {
            ...
            <div key={field.id} className="flex flex-col gap-3">
              <div className="flex items-end gap-2">
                <div className="flex-1">
                  <FormTextInput
                    id={`campaign-section-label-${index}`}
              ...
              <FormRichTextInput
                id={`campaign-section-description-${index}`}
