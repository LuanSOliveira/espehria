...
export class FindLocationsQueryDto {
  ...
  @ApiPropertyOptional({
    ...
    isArray: true,
    description:
      'Filtro por tags (array de UUIDs). Retorna apenas locais que possuem TODAS as tags informadas (AND). Na querystring, use a notação com colchetes: `tagIds[]=uuid1&tagIds[]=uuid2&...`',
