...
export class ConditionSectionResponseDto {
  @ApiProperty({
    format: 'uuid',
  ...
  static fromEntity(section: ConditionSection): ConditionSectionResponseDto {
    const dto = new ConditionSectionResponseDto();
    dto.id = section.id;
