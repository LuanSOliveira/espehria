  ...
  async findAllPaginated(
    ...
    if (hasTagFilter) {
      ...
      queryBuilder
        .innerJoin(
          'consumable_tags',
          'consumable_tag_filter',
          'consumable_tag_filter.consumable_id = consumable.id AND consumable_tag_filter.tag_id IN (:...tagIds)',
          { tagIds: uniqueTagIds },
        )
        .groupBy('consumable.id')
        .having('COUNT(DISTINCT consumable_tag_filter.tag_id) = :tagCount', {
