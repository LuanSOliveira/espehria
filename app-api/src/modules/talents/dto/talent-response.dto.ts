...
export class TalentResponseDto {
  ...
  @ApiProperty({
    type: () => [TagResponseDto],
    description: 'Tags associadas ao talento, na ordem de inserção',
  })
  tags: TagResponseDto[];
  ...
  @ApiProperty({
    ...
    description:
      'Proficiências associadas a este talento, na ordem em que foram inseridas',
  })
  ...
  @ApiProperty({
    ...
    description:
      'Saberes associados a este talento, na ordem em que foram inseridos',
  })
