...
export class CreateCharacteristicDto {
  ...
  @ApiPropertyOptional({
    ...
    format: 'uuid',
    description:
      'IDs das tags associadas à característica, na ordem de inserção preservada (array de UUIDs válidos)',
  ...
  @ApiPropertyOptional({
    ...
    description:
      'Itens exigidos como requisito para esta característica. Não pode referenciar a si mesmo, conter duplicatas ou estar simultaneamente em Habilidades Adicionais.',
    example: [
      {
  ...
  @ApiPropertyOptional({
    type: () => [EntityReferenceInputDto],
    description:
      'Habilidades adicionais associadas a esta característica. Não pode referenciar a si mesmo, conter duplicatas ou estar simultaneamente em Requisitos.',
    example: [
      {
        entityType: 'technique',
  ...
  @ApiPropertyOptional({
    ...
    description:
      'Proficiências associadas a esta característica. Não pode repetir a mesma propriedade nesta lista.',
    example: [
      {
  ...
  @ApiPropertyOptional({
    ...
    description:
      'Saberes associados a esta característica. Não pode repetir o mesmo título (case-insensitive e trim) nesta lista.',
    example: [
      {
