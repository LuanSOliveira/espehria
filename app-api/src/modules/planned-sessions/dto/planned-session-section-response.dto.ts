...
export class PlannedSessionSectionResponseDto {
  @ApiProperty({
    format: 'uuid',
  ...
  static fromEntity(
    section: PlannedSessionSection,
  ): PlannedSessionSectionResponseDto {
    const dto = new PlannedSessionSectionResponseDto();
    dto.id = section.id;
