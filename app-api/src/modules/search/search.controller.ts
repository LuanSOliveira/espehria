...
export class SearchController {
  ...
  @ApiOperation({
    summary:
      'Busca entidades linkáveis (usuários, criaturas, tags, locais, raças, eras, eventos, divindades, personagens, organizações, famílias, equipamentos, materiais, consumíveis, munições, utilitários, regras, perícias e condições) por nome, para uso em menções (@mention)',
  })
