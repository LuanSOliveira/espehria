...
export class SearchResultItemResponseDto {
  ...
  @ApiProperty({
    ...
    description:
      'Tipo de entidade linkável (campanha, sessão planejada, usuário, criatura, tag, local, raça, era, evento, divindade, personagem, organização, família, equipamento, material, consumível, munição, utilitário, regra, perícia, condição, treinamento, talento, técnica, magia, característica ou biografia). Campanhas e sessões planejadas aparecem apenas se pertencem ao usuário autenticado; usuários Google não veem esses tipos',
  })
