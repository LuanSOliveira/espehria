...
export class SearchResultItemResponseDto {
  ...
  @ApiProperty({
    ...
    description:
      'Tipo de entidade linkável (usuário, criatura, tag, local, raça, era, evento, divindade, personagem, organização, família, equipamento, material, consumível, munição ou regra)',
  })
